...
INSERT INTO OFFICE(id, VERSION, OFFICE_NAME, PHONE, ADDRESS, IS_ACTIVE, ORGANIZATION_ID) VALUES (
2, 1, 'Bell office2', '916', 'qwerty', 1, 1);
...
INSERT INTO POSITION(id, VERSION, POSITION_NAME) VALUES (2, 1, 'Java Senior2');

INSERT INTO POSITION(id, VERSION, POSITION_NAME) VALUES (3, 1, 'Java Senior3');
...
INSERT INTO USR_POSITION VALUES (1, 2);

INSERT INTO USR_POSITION VALUES (1, 1);

INSERT INTO USR_POSITION VALUES (2, 1);

INSERT INTO USR_POSITION VALUES (3, 3);
